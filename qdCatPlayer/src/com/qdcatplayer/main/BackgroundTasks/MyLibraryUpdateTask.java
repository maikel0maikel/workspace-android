...
public class MyLibraryUpdateTask {
	...
	public MyLibraryUpdateTask(ArrayList<MyFolder> folders, Context ctx,
			OnBGTaskWorkingListener listener) {
	...
	public class MyTask extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			/*
			 * for(MyFolder item:folders) { MyFolder new_obj =
			 * dao.getByAbsPath(item.getAbsPath()); if(new_obj!=null) {
			 * 
			 * } }
			 */
			dao.release();
