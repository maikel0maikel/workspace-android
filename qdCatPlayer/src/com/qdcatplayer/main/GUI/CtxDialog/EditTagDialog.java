...
public class EditTagDialog extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle saveInstanceState)
	{
		...
		View v=inflater.inflate(R.layout.edittag_dialog_fragment,container,true);
		...
		else txtAlbum.setText(obj.getAlbum().getName());
		...
		btnOK.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				obj.getAlbum().setName("");
//				obj.getArtist().setName("");
