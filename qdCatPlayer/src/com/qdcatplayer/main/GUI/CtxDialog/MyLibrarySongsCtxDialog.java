...
public class MyLibrarySongsCtxDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		loadResource();
		ArrayAdapter<String> adp=new ArrayAdapter<String>(getContext(), android.R.layout.simple_list_item_1, values);
		lv.setAdapter(adp);
	...
	private void loadResource() {
		ids = getContext().getResources().getStringArray(R.array.library_ctx_songs_id_array);
		values = getContext().getResources()
				.getStringArray(R.array.library_ctx_songs_value_array);
