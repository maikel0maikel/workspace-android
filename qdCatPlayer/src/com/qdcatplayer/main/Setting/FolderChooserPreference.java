...
public class FolderChooserPreference extends ListPreference {
	...
	/**
	 * Luu ds cac folder duoc chon khi co su thay doi tu ng dung Sau do khi
	 * click OK thi se su dung de lay ds cac Folder duoc chon cuoi cung
	 */
	...
	/**
	 * Rat quan trong, neu khong co contructor nay thi o PrefenceScreen khong
	 * the goi khoi tao nhu mot element duoc
	 * 
	 * @param context
	 * @param attrs
	 */
	...
	private HashMap<String, MyFolder> validateChooser(
