...
public class InstagramPhotoDbAdapter {
	...
	private static final String DATABASE_TABLE = "instagramphoto";
	...
	public long createPhoto(InstagramPhoto photoToCreate) {
		...
		if (photoToCreate.is_favorite!=null)
			initialValues.put("is_favorite", photoToCreate.is_favorite);	
	...
	public static InstagramPhoto getPhotoFromCursor(Cursor cursor){
		...
		photo.is_favorite = cursor.getInt(cursor.getColumnIndex("is_favorite"));
		return(photo);
	}
	...
	public boolean updatePhoto(String id, InstagramPhoto photoToUpdate) {
		...
		if (photoToUpdate.is_favorite!=null)
			updateValues.put("is_favorite", photoToUpdate.is_favorite);	
